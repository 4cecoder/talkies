...
pub const struct_pa_sample_spec = extern struct {
    ...
    rate: u32 = 0,
    channels: u8 = 0,
    pub const pa_bytes_per_second = __root.pa_bytes_per_second;
    pub const pa_frame_size = __root.pa_frame_size;
    pub const pa_sample_size = __root.pa_sample_size;
    pub const pa_sample_spec_init = __root.pa_sample_spec_init;
    pub const pa_sample_spec_valid = __root.pa_sample_spec_valid;
    pub const pa_sample_spec_equal = __root.pa_sample_spec_equal;
    pub const second = __root.pa_bytes_per_second;
    pub const size = __root.pa_frame_size;
    pub const init = __root.pa_sample_spec_init;
    pub const valid = __root.pa_sample_spec_valid;
    pub const equal = __root.pa_sample_spec_equal;
};
...
pub const struct_pa_channel_map = extern struct {
    ...
    pub const pa_channel_map_init = __root.pa_channel_map_init;
    pub const pa_channel_map_init_mono = __root.pa_channel_map_init_mono;
    pub const pa_channel_map_init_stereo = __root.pa_channel_map_init_stereo;
    pub const pa_channel_map_init_auto = __root.pa_channel_map_init_auto;
    pub const pa_channel_map_init_extend = __root.pa_channel_map_init_extend;
    pub const pa_channel_map_parse = __root.pa_channel_map_parse;
    pub const pa_channel_map_equal = __root.pa_channel_map_equal;
    pub const pa_channel_map_valid = __root.pa_channel_map_valid;
    pub const pa_channel_map_compatible = __root.pa_channel_map_compatible;
    pub const pa_channel_map_superset = __root.pa_channel_map_superset;
    pub const pa_channel_map_can_balance = __root.pa_channel_map_can_balance;
    pub const pa_channel_map_can_fade = __root.pa_channel_map_can_fade;
    pub const pa_channel_map_can_lfe_balance = __root.pa_channel_map_can_lfe_balance;
    pub const pa_channel_map_to_name = __root.pa_channel_map_to_name;
    pub const pa_channel_map_to_pretty_name = __root.pa_channel_map_to_pretty_name;
    pub const pa_channel_map_has_position = __root.pa_channel_map_has_position;
    pub const pa_channel_map_mask = __root.pa_channel_map_mask;
    pub const init = __root.pa_channel_map_init;
    pub const mono = __root.pa_channel_map_init_mono;
    pub const stereo = __root.pa_channel_map_init_stereo;
    pub const auto = __root.pa_channel_map_init_auto;
    pub const extend = __root.pa_channel_map_init_extend;
    pub const parse = __root.pa_channel_map_parse;
    pub const equal = __root.pa_channel_map_equal;
    pub const valid = __root.pa_channel_map_valid;
    pub const compatible = __root.pa_channel_map_compatible;
    pub const superset = __root.pa_channel_map_superset;
    pub const balance = __root.pa_channel_map_can_balance;
    pub const fade = __root.pa_channel_map_can_fade;
    pub const name = __root.pa_channel_map_to_name;
    pub const position = __root.pa_channel_map_has_position;
    pub const mask = __root.pa_channel_map_mask;
};
...
pub fn PA_CONTEXT_IS_GOOD(arg_x: pa_context_state_t) callconv(.c) c_int {
    var x = arg_x;
    _ = &x;
    return @intFromBool((((x == @as(pa_context_state_t, PA_CONTEXT_CONNECTING)) or (x == @as(pa_context_state_t, PA_CONTEXT_AUTHORIZING))) or (x == @as(pa_context_state_t, PA_CONTEXT_SETTING_NAME))) or (x == @as(pa_context_state_t, PA_CONTEXT_READY)));
}
...
pub fn PA_STREAM_IS_GOOD(arg_x: pa_stream_state_t) callconv(.c) c_int {
    var x = arg_x;
    _ = &x;
    return @intFromBool((x == @as(pa_stream_state_t, PA_STREAM_CREATING)) or (x == @as(pa_stream_state_t, PA_STREAM_READY)));
}
...
pub const struct_pa_timing_info = extern struct {
    ...
    synchronized_clocks: c_int = 0,
    sink_usec: pa_usec_t = 0,
    source_usec: pa_usec_t = 0,
    transport_usec: pa_usec_t = 0,
    playing: c_int = 0,
    write_index_corrupt: c_int = 0,
    write_index: i64 = 0,
    read_index_corrupt: c_int = 0,
    read_index: i64 = 0,
    configured_sink_usec: pa_usec_t = 0,
    configured_source_usec: pa_usec_t = 0,
    since_underrun: i64 = 0,
};
pub const pa_timing_info = struct_pa_timing_info;
pub const struct_pa_spawn_api = extern struct {
    prefork: ?*const fn () callconv(.c) void = null,
    postfork: ?*const fn () callconv(.c) void = null,
    atfork: ?*const fn () callconv(.c) void = null,
};
...
pub const pa_free_cb_t = ?*const fn (p: ?*anyopaque) callconv(.c) void;
...
pub const struct_pa_simple = opaque {
    pub const pa_simple_free = __root.pa_simple_free;
    pub const pa_simple_write = __root.pa_simple_write;
    pub const pa_simple_drain = __root.pa_simple_drain;
    pub const pa_simple_read = __root.pa_simple_read;
    pub const pa_simple_get_latency = __root.pa_simple_get_latency;
    pub const pa_simple_flush = __root.pa_simple_flush;
    pub const free = __root.pa_simple_free;
    pub const write = __root.pa_simple_write;
    pub const drain = __root.pa_simple_drain;
    pub const read = __root.pa_simple_read;
    pub const latency = __root.pa_simple_get_latency;
    pub const flush = __root.pa_simple_flush;
};
...
pub const __USER_HZ = @as(c_int, 100);
pub const HZ = __USER_HZ;
...
pub const NCARGS = __helpers.promoteIntLiteral(c_int, 131072, .decimal);
pub const NBBY = CHAR_BIT;
pub const NGROUPS = NGROUPS_MAX;
pub const CANBSIZ = MAX_CANON;
pub const MAXPATHLEN = PATH_MAX;
pub const NODEV = __helpers.cast(dev_t, -@as(c_int, 1));
...
pub inline fn isset(a: anytype, i: anytype) @TypeOf(a[@as(usize, @intCast(__helpers.div(i, NBBY)))] & (@as(c_int, 1) << __helpers.rem(i, NBBY))) {
    _ = &a;
    _ = &i;
    return a[@as(usize, @intCast(__helpers.div(i, NBBY)))] & (@as(c_int, 1) << __helpers.rem(i, NBBY));
}
pub inline fn isclr(a: anytype, i: anytype) @TypeOf((a[@as(usize, @intCast(__helpers.div(i, NBBY)))] & (@as(c_int, 1) << __helpers.rem(i, NBBY))) == @as(c_int, 0)) {
    _ = &a;
    _ = &i;
    return (a[@as(usize, @intCast(__helpers.div(i, NBBY)))] & (@as(c_int, 1) << __helpers.rem(i, NBBY))) == @as(c_int, 0);
}
pub inline fn howmany(x: anytype, y: anytype) @TypeOf(__helpers.div(x + (y - @as(c_int, 1)), y)) {
    _ = &x;
    _ = &y;
    return __helpers.div(x + (y - @as(c_int, 1)), y);
}
pub inline fn roundup(x: anytype, y: anytype) @TypeOf(if ((__builtin.constant_p(y) != 0) and (powerof2(y) != 0)) ((x + y) - @as(c_int, 1)) & ~(y - @as(c_int, 1)) else __helpers.div(x + (y - @as(c_int, 1)), y) * y) {
    _ = &x;
    _ = &y;
    return if ((__builtin.constant_p(y) != 0) and (powerof2(y) != 0)) ((x + y) - @as(c_int, 1)) & ~(y - @as(c_int, 1)) else __helpers.div(x + (y - @as(c_int, 1)), y) * y;
}
...
pub const PA_GCC_PRINTF_ATTR = @compileError("unable to translate macro: undefined identifier `format`"); // /usr/include/pulse/gccmacro.h:31:9
pub const PA_GCC_SENTINEL = @compileError("unable to translate macro: undefined identifier `sentinel`"); // /usr/include/pulse/gccmacro.h:39:9
pub const PA_GCC_NORETURN = @compileError("unable to translate macro: undefined identifier `noreturn`"); // /usr/include/pulse/gccmacro.h:46:9
pub const PA_GCC_UNUSED = @compileError("unable to translate macro: undefined identifier `unused`"); // /usr/include/pulse/gccmacro.h:53:9
pub const PA_GCC_DESTRUCTOR = @compileError("unable to translate macro: undefined identifier `destructor`"); // /usr/include/pulse/gccmacro.h:60:9
pub const PA_GCC_PURE = @compileError("unable to translate macro: undefined identifier `pure`"); // /usr/include/pulse/gccmacro.h:68:9
pub const PA_GCC_CONST = @compileError("unable to translate C expr: unexpected token '__attribute__'"); // /usr/include/pulse/gccmacro.h:77:9
pub const PA_GCC_DEPRECATED = @compileError("unable to translate macro: undefined identifier `deprecated`"); // /usr/include/pulse/gccmacro.h:86:9
pub const PA_GCC_PACKED = @compileError("unable to translate macro: undefined identifier `packed`"); // /usr/include/pulse/gccmacro.h:95:9
pub inline fn PA_GCC_ALLOC_SIZE(x: anytype) void {
    _ = &x;
    return;
}
pub inline fn PA_GCC_ALLOC_SIZE2(x: anytype, y: anytype) void {
    _ = &x;
    _ = &y;
    return;
}
pub const PA_GCC_MALLOC = @compileError("unable to translate macro: undefined identifier `malloc`"); // /usr/include/pulse/gccmacro.h:116:9
pub const PA_GCC_WEAKREF = @compileError("unable to translate macro: undefined identifier `weakref`"); // /usr/include/pulse/gccmacro.h:126:9
pub inline fn PA_LIKELY(x: anytype) @TypeOf(__builtin.expect(!!(x != 0), @as(c_int, 1))) {
    _ = &x;
    return __builtin.expect(!!(x != 0), @as(c_int, 1));
}
pub inline fn PA_UNLIKELY(x: anytype) @TypeOf(__builtin.expect(!!(x != 0), @as(c_int, 0))) {
    _ = &x;
    return __builtin.expect(!!(x != 0), @as(c_int, 0));
}
pub const PA_CLAMP = @compileError("unable to translate macro: undefined identifier `_x`"); // /usr/include/pulse/gccmacro.h:141:9
pub const PA_CLAMP_UNLIKELY = @compileError("unable to translate macro: undefined identifier `_x`"); // /usr/include/pulse/gccmacro.h:153:9
pub const foopulsecdeclhfoo = "";
pub const PA_C_DECL_BEGIN = "";
pub const PA_C_DECL_END = "";
pub const fooversionhfoo = "";
pub inline fn pa_get_headers_version() @TypeOf("17.0.0") {
    return "17.0.0";
}
pub const PA_API_VERSION = @as(c_int, 12);
pub const PA_PROTOCOL_VERSION = @as(c_int, 35);
pub const PA_MAJOR = @as(c_int, 17);
pub const PA_MINOR = @as(c_int, 0);
...
pub const PA_RATE_MAX = @as(c_uint, 48000) * @as(c_uint, 16);
...
pub inline fn PA_CHANNEL_POSITION_MASK(f: anytype) pa_channel_position_mask_t {
    _ = &f;
    return __helpers.cast(pa_channel_position_mask_t, @as(c_ulonglong, 1) << f);
}
...
pub const timercmp = @compileError("unable to translate C expr: expected ')' instead got ''"); // /usr/include/sys/time.h:233:10
...
pub const PA_INVALID_INDEX = __helpers.cast(u32, -@as(c_int, 1));
