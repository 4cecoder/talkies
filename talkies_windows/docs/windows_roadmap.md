...
- Native transcription: whisper.net with GGML models (tiny/base/small/medium/large), selectable model mapping, default ggml-tiny/base path override.
...
- Settings persistence: store model/language/mic/LLM/TTS/insert toggles + endpoints in `%APPDATA%\Talkies\talkies_settings.json`.
