            ...
            <div className="mt-8 pt-6 border-t border-white/10">
              ...
              <div className="grid grid-cols-2 gap-3">
                <div className="relative group">
                  ...
                  <span className="absolute -top-2 -right-2 bg-purple-600 text-white text-[10px] font-semibold px-2 py-0.5 rounded-full pointer-events-none">
                    Soon
                  </span>
                  {/* Tooltip on hover */}
                  <div className="absolute bottom-full left-1/2 -translate-x-1/2 mb-2 px-3 py-1.5 bg-neutral-800 text-white text-xs rounded-lg opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none whitespace-nowrap z-10">
                    Coming Soon
                  </div>
                </div>
                <div className="relative group">
