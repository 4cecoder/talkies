...
| Cross-platform contract | Shared local-vocabulary, S1-mini prompt, and TXT/VTT/SRT export golden fixtures on macOS, Windows, and Linux; model manifest schema validation |
